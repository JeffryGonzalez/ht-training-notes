...
This course will emphasize (but not be limited to) developer testing of HTTP based APIs created with .NET. Developers should consider taking [Web APIs with .NET](#web-apis-with-net) first.
