...
This course is designed for .NET Developers that know how to create HTTP Based Services. It is recommended that developers take [Web APIs with .NET](/services-training/web-api) prior to taking this course.
