...
This course is for software developers using C# and .NET to create APIs using ASP.NET MVC. It is expected the developers are proficient with C#, and have an understanding of DevOps practices like CI/CD, configuration management, and containers. For a thorough primer, see [DevOps for Deveopers](#devops-for-developers)
